...
const LABELS_ACTIONS: Record<string, string> = {
  ...
  DEPENSE_CREEE:       'Nouvelle dépense',
...
const DESCRIPTIONS_ACTIONS: Record<string, string> = {
  ...
  VENTE_CREEE:       'Une nouvelle vente a été enregistrée',
  ...
  DEPENSE_CREEE:     'Une nouvelle dépense a été saisie',
  ...
  COMMANDE_RECUE:    'Une commande a été marquée reçue et le stock mis à jour',
